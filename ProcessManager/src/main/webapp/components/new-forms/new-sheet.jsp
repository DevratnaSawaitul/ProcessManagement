...
<div id="new-sheet-modal">
	<div class="new-sheet-content">
		...
		<div class="new-sheet-body" id="new-sheet-body">
			...
			<div class="input-field">
				<label for="version">Version:</label> <input type="text"
					id="version" placeholder="Enter version" oninput="validateInputs()">
			</div>
			<div class="input-field">
			...
			<div class="input-field">
				<label for="floor">Floor:</label> <input type="text" id="floor"
					placeholder="Enter floor" oninput="validateInputs()">
			</div>
			<div class="input-field">
				<label for="lastUpdatedBy">Last Updated By:</label> <input
					type="text" id="lastUpdatedBy" placeholder="Enter updater's name"
					oninput="validateInputs()">
			</div>
		</div>
		<!-- Loader Element -->
		...
		<div class="new-sheet-footer">
			<button class="save-btn" id="saveBtn" onclick="saveNewSheetData()"
